...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HelloWorldFlixel", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HelloWorldFlixel";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HelloWorldFlixel", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "2",
			company: "HaxeFlixel",
			file: "HelloWorldFlixel",
			fps: 60,
			name: "HelloWorldFlixel",
