...
Void FlxSplash_obj::create( ){
{
		...
		HX_STACK_LINE(52)
		{
			...
			while((true)){
				...
				++(_g);
				HX_STACK_LINE(54)
				Float tmp14 = time;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(54)
				Dynamic tmp15 = this->timerCallback_dyn();		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(54)
				::flixel::util::FlxTimer_obj::__new(tmp14,tmp15,null());
			}
		}
		HX_STACK_LINE(57)
		...
		HX_STACK_LINE(76)
		{
			...
			HX_STACK_LINE(76)
			::String tmp38 = (HX_HCSTRING("assets/sounds/flixel","\xbb","\x1d","\xbd","\x3f") + extension);		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(76)
			tmp37 = ::openfl::_legacy::Assets_obj::getSound(tmp38,null());
		}
		HX_STACK_LINE(76)
		::flixel::_system::FlxSound tmp38 = tmp36->__Field(HX_HCSTRING("load","\x26","\x9a","\xb7","\x47"), hx::paccDynamic )(tmp37,null(),null(),null(),null(),null(),null());		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(76)
			...
			struct _Function_2_2{
				inline static Dynamic Block( Dynamic &tmp11,Dynamic &tmp10){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","flixel/system/FlxSplash.hx",116,0xa5de80f2)
					{
						...
						__result->Add(HX_HCSTRING("complete","\xb9","\x00","\xc8","\x7f") , tmp11,false);
						return __result;
					}
					return null();
				}
...
Void FlxSplash_obj::onComplete( ::flixel::tweens::FlxTween Tween){
{
		...
		HX_STACK_LINE(194)
		{
			...
			HX_STACK_LINE(194)
			::flixel::FlxState State = tmp12;		HX_STACK_VAR(State,"State");
			HX_STACK_LINE(194)
			::flixel::FlxGame tmp13 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(194)
			tmp13->_requestedState = State;
		}
		HX_STACK_LINE(195)
