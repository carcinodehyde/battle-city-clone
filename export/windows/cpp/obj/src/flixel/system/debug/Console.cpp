...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(109)
	tmp21->addEventListener(HX_HCSTRING("focusIn","\xdd","\x45","\x83","\x41"),tmp22,null(),null(),null());
	HX_STACK_LINE(110)
	::openfl::_legacy::text::TextField tmp23 = this->_input;		HX_STACK_VAR(tmp23,"tmp23");
	HX_STACK_LINE(110)
	Dynamic tmp24 = this->onFocusLost_dyn();		HX_STACK_VAR(tmp24,"tmp24");
	HX_STACK_LINE(110)
	tmp23->addEventListener(HX_HCSTRING("focusOut","\x96","\x6f","\x5e","\x11"),tmp24,null(),null(),null());
	HX_STACK_LINE(111)
	::openfl::_legacy::text::TextField tmp25 = this->_input;		HX_STACK_VAR(tmp25,"tmp25");
	HX_STACK_LINE(111)
	::String tmp26 = ::openfl::_legacy::events::KeyboardEvent_obj::KEY_DOWN;		HX_STACK_VAR(tmp26,"tmp26");
	HX_STACK_LINE(111)
	Dynamic tmp27 = this->onKeyPress_dyn();		HX_STACK_VAR(tmp27,"tmp27");
	HX_STACK_LINE(111)
...
Void Console_obj::destroy( ){
{
		...
		HX_STACK_LINE(324)
		Dynamic tmp6 = this->onKeyPress_dyn();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(324)
