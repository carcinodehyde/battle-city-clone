...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(310)
		{
			...
			HX_STACK_LINE(310)
			tmp21->__Field(HX_HCSTRING("gameReset","\x7d","\x38","\xe3","\x1b"), hx::paccDynamic )->__Field(HX_HCSTRING("dispatch","\xba","\xce","\x63","\x1e"), hx::paccDynamic )();
			HX_STACK_LINE(310)
		...
		HX_STACK_LINE(313)
		int tmp22 = tmp21->_stepMS;		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(313)
