	...
	HX_STACK_ARG(interpolate,"interpolate")
{
		...
		if ((tmp20)){
			...
			HX_STACK_LINE(150)
			tmp21->beginGradientFill(::openfl::_legacy::display::GradientType_obj::LINEAR,((cpp::ArrayBase)(colors)),gradient->__Field(HX_HCSTRING("alpha","\x5e","\xa7","\x96","\x21"), hx::paccDynamic ),gradient->__Field(HX_HCSTRING("ratio","\x0b","\x35","\x24","\xe4"), hx::paccDynamic ),tmp22,::openfl::_legacy::display::SpreadMethod_obj::PAD,::openfl::_legacy::display::InterpolationMethod_obj::RGB,(int)0);
		}
		else{
			HX_STACK_LINE(156)
			::openfl::_legacy::display::Graphics tmp21 = s->get_graphics();		HX_STACK_VAR(tmp21,"tmp21");
			...
			::openfl::_legacy::geom::Matrix tmp22 = gradient->__Field(HX_HCSTRING("matrix","\x41","\x36","\xc8","\xbb"), hx::paccDynamic );		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(156)
			tmp21->beginGradientFill(::openfl::_legacy::display::GradientType_obj::LINEAR,((cpp::ArrayBase)(colors)),gradient->__Field(HX_HCSTRING("alpha","\x5e","\xa7","\x96","\x21"), hx::paccDynamic ),gradient->__Field(HX_HCSTRING("ratio","\x0b","\x35","\x24","\xe4"), hx::paccDynamic ),tmp22,::openfl::_legacy::display::SpreadMethod_obj::PAD,::openfl::_legacy::display::InterpolationMethod_obj::LINEAR_RGB,(int)0);
		}
		HX_STACK_LINE(160)
