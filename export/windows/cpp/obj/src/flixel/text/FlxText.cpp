...
bool FlxText_obj::set_autoSize( bool value){
	...
	if ((tmp1)){
		...
		if ((tmp2)){
			...
			::openfl::_legacy::text::TextField tmp3 = this->_textField;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(450)
			tmp3->set_autoSize(::openfl::_legacy::text::TextFieldAutoSize_obj::LEFT);
		}
		else{
			HX_STACK_LINE(452)
			::openfl::_legacy::text::TextField tmp3 = this->_textField;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(452)
			tmp3->set_autoSize(::openfl::_legacy::text::TextFieldAutoSize_obj::NONE);
		}
		HX_STACK_LINE(454)
		this->dirty = true;
	}
	...
	HX_STACK_ARG(RunOnCpp,"RunOnCpp")
{
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(778)
			bool tmp30 = (tmp29 == HX_HCSTRING("center","\xd5","\x25","\xdb","\x05"));		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(778)
			...
			if ((tmp30)){
				...
				::openfl::_legacy::text::TextField tmp32 = this->_textField;		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(778)
				::openfl::_legacy::text::TextField tmp33 = tmp32;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(778)
				int tmp34 = tmp33->get_numLines();		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(778)
			...
			if ((tmp31)){
				HX_STACK_LINE(780)
				::openfl::_legacy::text::TextFormat tmp32 = this->_formatAdjusted;		HX_STACK_VAR(tmp32,"tmp32");
				HX_STACK_LINE(780)
				tmp32->align = HX_HCSTRING("left","\x07","\x08","\xb0","\x47");
				HX_STACK_LINE(781)
				{
					HX_STACK_LINE(781)
					...
					HX_STACK_LINE(781)
					tmp33->setTextFormat(tmp34,(int)0,tmp37);
				}
				HX_STACK_LINE(786)
				::openfl::_legacy::geom::Matrix tmp33 = this->_matrix;		HX_STACK_VAR(tmp33,"tmp33");
				HX_STACK_LINE(786)
				Float tmp34 = this->get_width();		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(786)
				::openfl::_legacy::text::TextField tmp35 = this->_textField;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(786)
				Float tmp36 = tmp35->get_textWidth();		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(786)
				...
				HX_STACK_LINE(786)
				tmp33->translate(tmp39,(int)0);
			}
			HX_STACK_LINE(790)
			int tmp32 = this->borderStyle;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(790)
			bool tmp33 = (tmp32 != (int)0);		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(790)
			if ((tmp33)){
				HX_STACK_LINE(792)
				Float tmp34 = this->borderSize;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(792)
				Float tmp35 = this->borderQuality;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(792)
				Float tmp36 = (tmp34 * tmp35);		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(792)
				int tmp37 = ::Std_obj::_int(tmp36);		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(792)
				int iterations = tmp37;		HX_STACK_VAR(iterations,"iterations");
				HX_STACK_LINE(793)
				bool tmp38 = (iterations <= (int)0);		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(793)
				if ((tmp38)){
					HX_STACK_LINE(795)
					iterations = (int)1;
				...
				HX_STACK_LINE(797)
				Float tmp39 = this->borderSize;		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(797)
				int tmp40 = iterations;		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(797)
				Float tmp41 = (Float(tmp39) / Float(tmp40));		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(797)
				Float delta = tmp41;		HX_STACK_VAR(delta,"delta");
				HX_STACK_LINE(799)
				int tmp42 = this->borderStyle;		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(799)
				bool tmp43 = (tmp42 == (int)1);		HX_STACK_VAR(tmp43,"tmp43");
				HX_STACK_LINE(799)
				if ((tmp43)){
					HX_STACK_LINE(803)
					{
						HX_STACK_LINE(803)
						::openfl::_legacy::text::TextFormat tmp44 = this->_formatAdjusted;		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(803)
						::openfl::_legacy::text::TextFormat FormatAdjusted = tmp44;		HX_STACK_VAR(FormatAdjusted,"FormatAdjusted");
						HX_STACK_LINE(803)
						Dynamic tmp45;		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(803)
						tmp45 = this->borderColor;
						HX_STACK_LINE(803)
						FormatAdjusted->color = tmp45;
						HX_STACK_LINE(803)
						{
							HX_STACK_LINE(803)
							...
							HX_STACK_LINE(803)
							::openfl::_legacy::text::TextField tmp48 = this->_textField;		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(803)
							::String tmp49 = tmp48->get_text();		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(803)
							int tmp50 = tmp49.length;		HX_STACK_VAR(tmp50,"tmp50");
							HX_STACK_LINE(803)
							tmp46->setTextFormat(tmp47,(int)0,tmp50);
						}
						HX_STACK_LINE(803)
						{
							HX_STACK_LINE(803)
							...
							while((true)){
								HX_STACK_LINE(803)
								bool tmp46 = (_g < _g1->length);		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(803)
								...
								HX_STACK_LINE(803)
								::flixel::text::FlxTextFormat tmp48 = _g1->__get(_g).StaticCast< ::flixel::text::FlxTextFormat >();		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(803)
								::flixel::text::FlxTextFormat format = tmp48;		HX_STACK_VAR(format,"format");
								HX_STACK_LINE(803)
								++(_g);
								HX_STACK_LINE(803)
								...
								HX_STACK_LINE(803)
								int tmp53 = format->start;		HX_STACK_VAR(tmp53,"tmp53");
								HX_STACK_LINE(803)
								...
								if ((tmp54)){
									...
									HX_STACK_LINE(803)
									::String tmp55 = format->format->font;		HX_STACK_VAR(tmp55,"tmp55");
									HX_STACK_LINE(803)
									FormatAdjusted->font = tmp55;
									HX_STACK_LINE(803)
									Dynamic tmp56 = format->format->bold;		HX_STACK_VAR(tmp56,"tmp56");
									HX_STACK_LINE(803)
									FormatAdjusted->bold = tmp56;
									HX_STACK_LINE(803)
									Dynamic tmp57 = format->format->italic;		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(803)
									FormatAdjusted->italic = tmp57;
									HX_STACK_LINE(803)
									Dynamic tmp58 = format->format->size;		HX_STACK_VAR(tmp58,"tmp58");
									HX_STACK_LINE(803)
									FormatAdjusted->size = tmp58;
									HX_STACK_LINE(803)
									Dynamic tmp59;		HX_STACK_VAR(tmp59,"tmp59");
									HX_STACK_LINE(803)
									tmp59 = format->borderColor;
									HX_STACK_LINE(803)
									FormatAdjusted->color = tmp59;
								}
								HX_STACK_LINE(803)
								::openfl::_legacy::text::TextField tmp55 = this->_textField;		HX_STACK_VAR(tmp55,"tmp55");
								HX_STACK_LINE(803)
								::openfl::_legacy::text::TextFormat tmp56 = FormatAdjusted;		HX_STACK_VAR(tmp56,"tmp56");
								HX_STACK_LINE(803)
								int tmp57 = format->start;		HX_STACK_VAR(tmp57,"tmp57");
								HX_STACK_LINE(803)
								int tmp58 = format->end;		HX_STACK_VAR(tmp58,"tmp58");
								HX_STACK_LINE(803)
								::openfl::_legacy::text::TextField tmp59 = this->_textField;		HX_STACK_VAR(tmp59,"tmp59");
								HX_STACK_LINE(803)
								::String tmp60 = tmp59->get_text();		HX_STACK_VAR(tmp60,"tmp60");
								HX_STACK_LINE(803)
								int tmp61 = tmp60.length;		HX_STACK_VAR(tmp61,"tmp61");
								HX_STACK_LINE(803)
								Float tmp62 = ::Math_obj::min(tmp58,tmp61);		HX_STACK_VAR(tmp62,"tmp62");
								HX_STACK_LINE(803)
								int tmp63 = ::Std_obj::_int(tmp62);		HX_STACK_VAR(tmp63,"tmp63");
								HX_STACK_LINE(803)
								tmp55->setTextFormat(tmp56,tmp57,tmp63);
							}
						}
					}
					HX_STACK_LINE(805)
					{
						...
						while((true)){
							HX_STACK_LINE(805)
							bool tmp44 = (_g < iterations);		HX_STACK_VAR(tmp44,"tmp44");
							HX_STACK_LINE(805)
							...
							HX_STACK_LINE(805)
							int iter = tmp46;		HX_STACK_VAR(iter,"iter");
							HX_STACK_LINE(807)
							::openfl::_legacy::geom::Matrix tmp47 = this->_matrix;		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(807)
							Float tmp48 = delta;		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(807)
							Float tmp49 = delta;		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(807)
							tmp47->translate(tmp48,tmp49);
							HX_STACK_LINE(808)
							...
							HX_STACK_LINE(808)
							tmp50->bitmap->draw(tmp51,tmp52,null(),null(),null(),null());
						}
					}
					HX_STACK_LINE(811)
					::openfl::_legacy::geom::Matrix tmp44 = this->_matrix;		HX_STACK_VAR(tmp44,"tmp44");
					HX_STACK_LINE(811)
					::flixel::util::FlxPoint tmp45 = this->shadowOffset;		HX_STACK_VAR(tmp45,"tmp45");
					HX_STACK_LINE(811)
					Float tmp46 = tmp45->x;		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(811)
					Float tmp47 = -(tmp46);		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(811)
					Float tmp48 = this->borderSize;		HX_STACK_VAR(tmp48,"tmp48");
					HX_STACK_LINE(811)
					Float tmp49 = (tmp47 * tmp48);		HX_STACK_VAR(tmp49,"tmp49");
					HX_STACK_LINE(811)
					::flixel::util::FlxPoint tmp50 = this->shadowOffset;		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(811)
					...
					HX_STACK_LINE(811)
					tmp44->translate(tmp49,tmp54);
					HX_STACK_LINE(812)
					{
						HX_STACK_LINE(812)
						::openfl::_legacy::text::TextFormat tmp55 = this->_formatAdjusted;		HX_STACK_VAR(tmp55,"tmp55");
						HX_STACK_LINE(812)
						::openfl::_legacy::text::TextFormat FormatAdjusted = tmp55;		HX_STACK_VAR(FormatAdjusted,"FormatAdjusted");
						HX_STACK_LINE(812)
						Dynamic tmp56;		HX_STACK_VAR(tmp56,"tmp56");
						HX_STACK_LINE(812)
						{
							HX_STACK_LINE(812)
							::openfl::_legacy::text::TextFormat tmp57 = this->_defaultFormat;		HX_STACK_VAR(tmp57,"tmp57");
							HX_STACK_LINE(812)
							tmp56 = tmp57->color;
						}
						HX_STACK_LINE(812)
						FormatAdjusted->color = tmp56;
						HX_STACK_LINE(812)
						{
							HX_STACK_LINE(812)
							::openfl::_legacy::text::TextField tmp57 = this->_textField;		HX_STACK_VAR(tmp57,"tmp57");
							HX_STACK_LINE(812)
							::openfl::_legacy::text::TextFormat tmp58 = FormatAdjusted;		HX_STACK_VAR(tmp58,"tmp58");
							HX_STACK_LINE(812)
							::openfl::_legacy::text::TextField tmp59 = this->_textField;		HX_STACK_VAR(tmp59,"tmp59");
							HX_STACK_LINE(812)
							::String tmp60 = tmp59->get_text();		HX_STACK_VAR(tmp60,"tmp60");
							...
							int tmp61 = tmp60.length;		HX_STACK_VAR(tmp61,"tmp61");
							HX_STACK_LINE(812)
							tmp57->setTextFormat(tmp58,(int)0,tmp61);
						}
						HX_STACK_LINE(812)
						{
							HX_STACK_LINE(812)
							...
							while((true)){
								HX_STACK_LINE(812)
								bool tmp57 = (_g < _g1->length);		HX_STACK_VAR(tmp57,"tmp57");
								HX_STACK_LINE(812)
								...
								HX_STACK_LINE(812)
								::flixel::text::FlxTextFormat tmp59 = _g1->__get(_g).StaticCast< ::flixel::text::FlxTextFormat >();		HX_STACK_VAR(tmp59,"tmp59");
								HX_STACK_LINE(812)
								::flixel::text::FlxTextFormat format = tmp59;		HX_STACK_VAR(format,"format");
								HX_STACK_LINE(812)
								++(_g);
								HX_STACK_LINE(812)
								...
								HX_STACK_LINE(812)
								int tmp64 = format->start;		HX_STACK_VAR(tmp64,"tmp64");
								HX_STACK_LINE(812)
								...
								if ((tmp65)){
									...
									HX_STACK_LINE(812)
									::String tmp66 = format->format->font;		HX_STACK_VAR(tmp66,"tmp66");
									HX_STACK_LINE(812)
									FormatAdjusted->font = tmp66;
									HX_STACK_LINE(812)
									Dynamic tmp67 = format->format->bold;		HX_STACK_VAR(tmp67,"tmp67");
									HX_STACK_LINE(812)
									FormatAdjusted->bold = tmp67;
									HX_STACK_LINE(812)
									Dynamic tmp68 = format->format->italic;		HX_STACK_VAR(tmp68,"tmp68");
									HX_STACK_LINE(812)
									FormatAdjusted->italic = tmp68;
									HX_STACK_LINE(812)
									Dynamic tmp69 = format->format->size;		HX_STACK_VAR(tmp69,"tmp69");
									HX_STACK_LINE(812)
									FormatAdjusted->size = tmp69;
									HX_STACK_LINE(812)
									Dynamic tmp70;		HX_STACK_VAR(tmp70,"tmp70");
									HX_STACK_LINE(812)
									tmp70 = format->format->color;
									HX_STACK_LINE(812)
									FormatAdjusted->color = tmp70;
								}
								HX_STACK_LINE(812)
								::openfl::_legacy::text::TextField tmp66 = this->_textField;		HX_STACK_VAR(tmp66,"tmp66");
								HX_STACK_LINE(812)
								::openfl::_legacy::text::TextFormat tmp67 = FormatAdjusted;		HX_STACK_VAR(tmp67,"tmp67");
								HX_STACK_LINE(812)
								int tmp68 = format->start;		HX_STACK_VAR(tmp68,"tmp68");
								HX_STACK_LINE(812)
								int tmp69 = format->end;		HX_STACK_VAR(tmp69,"tmp69");
								HX_STACK_LINE(812)
								::openfl::_legacy::text::TextField tmp70 = this->_textField;		HX_STACK_VAR(tmp70,"tmp70");
								HX_STACK_LINE(812)
								::String tmp71 = tmp70->get_text();		HX_STACK_VAR(tmp71,"tmp71");
								HX_STACK_LINE(812)
								int tmp72 = tmp71.length;		HX_STACK_VAR(tmp72,"tmp72");
								HX_STACK_LINE(812)
								Float tmp73 = ::Math_obj::min(tmp69,tmp72);		HX_STACK_VAR(tmp73,"tmp73");
								HX_STACK_LINE(812)
								int tmp74 = ::Std_obj::_int(tmp73);		HX_STACK_VAR(tmp74,"tmp74");
								HX_STACK_LINE(812)
								tmp66->setTextFormat(tmp67,tmp68,tmp74);
							}
						}
					}
				}
					...
					HX_STACK_LINE(814)
					int tmp44 = this->borderStyle;		HX_STACK_VAR(tmp44,"tmp44");
					HX_STACK_LINE(814)
					...
					if ((tmp45)){
						...
						{
							HX_STACK_LINE(818)
							::openfl::_legacy::text::TextFormat tmp46 = this->_formatAdjusted;		HX_STACK_VAR(tmp46,"tmp46");
							HX_STACK_LINE(818)
							::openfl::_legacy::text::TextFormat FormatAdjusted = tmp46;		HX_STACK_VAR(FormatAdjusted,"FormatAdjusted");
							HX_STACK_LINE(818)
							Dynamic tmp47;		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(818)
							tmp47 = this->borderColor;
							HX_STACK_LINE(818)
							FormatAdjusted->color = tmp47;
							HX_STACK_LINE(818)
							{
								HX_STACK_LINE(818)
								::openfl::_legacy::text::TextField tmp48 = this->_textField;		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(818)
								::openfl::_legacy::text::TextFormat tmp49 = FormatAdjusted;		HX_STACK_VAR(tmp49,"tmp49");
								HX_STACK_LINE(818)
								...
								HX_STACK_LINE(818)
								tmp48->setTextFormat(tmp49,(int)0,tmp52);
							}
							HX_STACK_LINE(818)
							{
								HX_STACK_LINE(818)
								...
								while((true)){
									HX_STACK_LINE(818)
									bool tmp48 = (_g < _g1->length);		HX_STACK_VAR(tmp48,"tmp48");
									HX_STACK_LINE(818)
									...
									HX_STACK_LINE(818)
									::flixel::text::FlxTextFormat tmp50 = _g1->__get(_g).StaticCast< ::flixel::text::FlxTextFormat >();		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(818)
									::flixel::text::FlxTextFormat format = tmp50;		HX_STACK_VAR(format,"format");
									HX_STACK_LINE(818)
									++(_g);
									HX_STACK_LINE(818)
									::openfl::_legacy::text::TextField tmp51 = this->_textField;		HX_STACK_VAR(tmp51,"tmp51");
									...
									HX_STACK_LINE(818)
									int tmp55 = format->start;		HX_STACK_VAR(tmp55,"tmp55");
									HX_STACK_LINE(818)
									...
									if ((tmp56)){
										...
										HX_STACK_LINE(818)
										::String tmp57 = format->format->font;		HX_STACK_VAR(tmp57,"tmp57");
										HX_STACK_LINE(818)
										FormatAdjusted->font = tmp57;
										HX_STACK_LINE(818)
										Dynamic tmp58 = format->format->bold;		HX_STACK_VAR(tmp58,"tmp58");
										HX_STACK_LINE(818)
										FormatAdjusted->bold = tmp58;
										HX_STACK_LINE(818)
										Dynamic tmp59 = format->format->italic;		HX_STACK_VAR(tmp59,"tmp59");
										HX_STACK_LINE(818)
										FormatAdjusted->italic = tmp59;
										HX_STACK_LINE(818)
										Dynamic tmp60 = format->format->size;		HX_STACK_VAR(tmp60,"tmp60");
										HX_STACK_LINE(818)
										FormatAdjusted->size = tmp60;
										HX_STACK_LINE(818)
										Dynamic tmp61;		HX_STACK_VAR(tmp61,"tmp61");
										HX_STACK_LINE(818)
										tmp61 = format->borderColor;
										HX_STACK_LINE(818)
										FormatAdjusted->color = tmp61;
									}
									HX_STACK_LINE(818)
									::openfl::_legacy::text::TextField tmp57 = this->_textField;		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(818)
									::openfl::_legacy::text::TextFormat tmp58 = FormatAdjusted;		HX_STACK_VAR(tmp58,"tmp58");
									HX_STACK_LINE(818)
									int tmp59 = format->start;		HX_STACK_VAR(tmp59,"tmp59");
									HX_STACK_LINE(818)
									int tmp60 = format->end;		HX_STACK_VAR(tmp60,"tmp60");
									HX_STACK_LINE(818)
									...
									HX_STACK_LINE(818)
									Float tmp64 = ::Math_obj::min(tmp60,tmp63);		HX_STACK_VAR(tmp64,"tmp64");
									HX_STACK_LINE(818)
									int tmp65 = ::Std_obj::_int(tmp64);		HX_STACK_VAR(tmp65,"tmp65");
									HX_STACK_LINE(818)
									tmp57->setTextFormat(tmp58,tmp59,tmp65);
								}
							}
						}
						HX_STACK_LINE(820)
						...
						HX_STACK_LINE(821)
						{
							...
							while((true)){
								HX_STACK_LINE(821)
								bool tmp46 = (_g < iterations);		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(821)
								bool tmp47 = !(tmp46);		HX_STACK_VAR(tmp47,"tmp47");
								HX_STACK_LINE(821)
								if ((tmp47)){
								...
								HX_STACK_LINE(821)
								int iter = tmp48;		HX_STACK_VAR(iter,"iter");
								HX_STACK_LINE(823)
								::openfl::_legacy::geom::Matrix tmp49 = this->_matrix;		HX_STACK_VAR(tmp49,"tmp49");
								HX_STACK_LINE(823)
								Float tmp50 = itd;		HX_STACK_VAR(tmp50,"tmp50");
								HX_STACK_LINE(823)
								Float tmp51 = -(tmp50);		HX_STACK_VAR(tmp51,"tmp51");
								HX_STACK_LINE(823)
								Float tmp52 = itd;		HX_STACK_VAR(tmp52,"tmp52");
								HX_STACK_LINE(823)
								Float tmp53 = -(tmp52);		HX_STACK_VAR(tmp53,"tmp53");
								HX_STACK_LINE(823)
								tmp49->translate(tmp51,tmp53);
								HX_STACK_LINE(824)
								::flixel::util::loaders::CachedGraphics tmp54 = this->cachedGraphics;		HX_STACK_VAR(tmp54,"tmp54");
								HX_STACK_LINE(824)
								::openfl::_legacy::text::TextField tmp55 = this->_textField;		HX_STACK_VAR(tmp55,"tmp55");
								HX_STACK_LINE(824)
								::openfl::_legacy::geom::Matrix tmp56 = this->_matrix;		HX_STACK_VAR(tmp56,"tmp56");
								HX_STACK_LINE(824)
								tmp54->bitmap->draw(tmp55,tmp56,null(),null(),null(),null());
								HX_STACK_LINE(825)
								::openfl::_legacy::geom::Matrix tmp57 = this->_matrix;		HX_STACK_VAR(tmp57,"tmp57");
								HX_STACK_LINE(825)
								Float tmp58 = itd;		HX_STACK_VAR(tmp58,"tmp58");
								HX_STACK_LINE(825)
								tmp57->translate(tmp58,(int)0);
								HX_STACK_LINE(826)
								::flixel::util::loaders::CachedGraphics tmp59 = this->cachedGraphics;		HX_STACK_VAR(tmp59,"tmp59");
								HX_STACK_LINE(826)
								::openfl::_legacy::text::TextField tmp60 = this->_textField;		HX_STACK_VAR(tmp60,"tmp60");
								HX_STACK_LINE(826)
								::openfl::_legacy::geom::Matrix tmp61 = this->_matrix;		HX_STACK_VAR(tmp61,"tmp61");
								HX_STACK_LINE(826)
								tmp59->bitmap->draw(tmp60,tmp61,null(),null(),null(),null());
								HX_STACK_LINE(827)
								::openfl::_legacy::geom::Matrix tmp62 = this->_matrix;		HX_STACK_VAR(tmp62,"tmp62");
								HX_STACK_LINE(827)
								Float tmp63 = itd;		HX_STACK_VAR(tmp63,"tmp63");
								HX_STACK_LINE(827)
								tmp62->translate(tmp63,(int)0);
								HX_STACK_LINE(828)
								::flixel::util::loaders::CachedGraphics tmp64 = this->cachedGraphics;		HX_STACK_VAR(tmp64,"tmp64");
								HX_STACK_LINE(828)
								::openfl::_legacy::text::TextField tmp65 = this->_textField;		HX_STACK_VAR(tmp65,"tmp65");
								HX_STACK_LINE(828)
								::openfl::_legacy::geom::Matrix tmp66 = this->_matrix;		HX_STACK_VAR(tmp66,"tmp66");
								HX_STACK_LINE(828)
								tmp64->bitmap->draw(tmp65,tmp66,null(),null(),null(),null());
								HX_STACK_LINE(829)
								::openfl::_legacy::geom::Matrix tmp67 = this->_matrix;		HX_STACK_VAR(tmp67,"tmp67");
								HX_STACK_LINE(829)
								Float tmp68 = itd;		HX_STACK_VAR(tmp68,"tmp68");
								HX_STACK_LINE(829)
								tmp67->translate((int)0,tmp68);
								HX_STACK_LINE(830)
								::flixel::util::loaders::CachedGraphics tmp69 = this->cachedGraphics;		HX_STACK_VAR(tmp69,"tmp69");
								HX_STACK_LINE(830)
								::openfl::_legacy::text::TextField tmp70 = this->_textField;		HX_STACK_VAR(tmp70,"tmp70");
								HX_STACK_LINE(830)
								::openfl::_legacy::geom::Matrix tmp71 = this->_matrix;		HX_STACK_VAR(tmp71,"tmp71");
								HX_STACK_LINE(830)
								tmp69->bitmap->draw(tmp70,tmp71,null(),null(),null(),null());
								HX_STACK_LINE(831)
								::openfl::_legacy::geom::Matrix tmp72 = this->_matrix;		HX_STACK_VAR(tmp72,"tmp72");
								HX_STACK_LINE(831)
								Float tmp73 = itd;		HX_STACK_VAR(tmp73,"tmp73");
								HX_STACK_LINE(831)
								tmp72->translate((int)0,tmp73);
								HX_STACK_LINE(832)
								...
								HX_STACK_LINE(833)
								tmp77->translate(tmp79,(int)0);
								HX_STACK_LINE(834)
								::flixel::util::loaders::CachedGraphics tmp80 = this->cachedGraphics;		HX_STACK_VAR(tmp80,"tmp80");
								HX_STACK_LINE(834)
								::openfl::_legacy::text::TextField tmp81 = this->_textField;		HX_STACK_VAR(tmp81,"tmp81");
								HX_STACK_LINE(834)
								::openfl::_legacy::geom::Matrix tmp82 = this->_matrix;		HX_STACK_VAR(tmp82,"tmp82");
								HX_STACK_LINE(834)
								tmp80->bitmap->draw(tmp81,tmp82,null(),null(),null(),null());
								HX_STACK_LINE(835)
								::openfl::_legacy::geom::Matrix tmp83 = this->_matrix;		HX_STACK_VAR(tmp83,"tmp83");
								HX_STACK_LINE(835)
								Float tmp84 = itd;		HX_STACK_VAR(tmp84,"tmp84");
								HX_STACK_LINE(835)
								Float tmp85 = -(tmp84);		HX_STACK_VAR(tmp85,"tmp85");
								HX_STACK_LINE(835)
								tmp83->translate(tmp85,(int)0);
								HX_STACK_LINE(836)
								::flixel::util::loaders::CachedGraphics tmp86 = this->cachedGraphics;		HX_STACK_VAR(tmp86,"tmp86");
								HX_STACK_LINE(836)
								::openfl::_legacy::text::TextField tmp87 = this->_textField;		HX_STACK_VAR(tmp87,"tmp87");
								HX_STACK_LINE(836)
								::openfl::_legacy::geom::Matrix tmp88 = this->_matrix;		HX_STACK_VAR(tmp88,"tmp88");
								HX_STACK_LINE(836)
								tmp86->bitmap->draw(tmp87,tmp88,null(),null(),null(),null());
								HX_STACK_LINE(837)
								::openfl::_legacy::geom::Matrix tmp89 = this->_matrix;		HX_STACK_VAR(tmp89,"tmp89");
								HX_STACK_LINE(837)
								Float tmp90 = itd;		HX_STACK_VAR(tmp90,"tmp90");
								HX_STACK_LINE(837)
								Float tmp91 = -(tmp90);		HX_STACK_VAR(tmp91,"tmp91");
								HX_STACK_LINE(837)
								tmp89->translate((int)0,tmp91);
								HX_STACK_LINE(838)
								::flixel::util::loaders::CachedGraphics tmp92 = this->cachedGraphics;		HX_STACK_VAR(tmp92,"tmp92");
								HX_STACK_LINE(838)
								::openfl::_legacy::text::TextField tmp93 = this->_textField;		HX_STACK_VAR(tmp93,"tmp93");
								HX_STACK_LINE(838)
								::openfl::_legacy::geom::Matrix tmp94 = this->_matrix;		HX_STACK_VAR(tmp94,"tmp94");
								HX_STACK_LINE(838)
								tmp92->bitmap->draw(tmp93,tmp94,null(),null(),null(),null());
								HX_STACK_LINE(839)
								::openfl::_legacy::geom::Matrix tmp95 = this->_matrix;		HX_STACK_VAR(tmp95,"tmp95");
								HX_STACK_LINE(839)
								Float tmp96 = itd;		HX_STACK_VAR(tmp96,"tmp96");
								HX_STACK_LINE(839)
								tmp95->translate(tmp96,(int)0);
								HX_STACK_LINE(840)
								hx::AddEq(itd,delta);
							}
						}
						HX_STACK_LINE(843)
						{
							...
							{
								HX_STACK_LINE(843)
								::openfl::_legacy::text::TextFormat tmp48 = this->_defaultFormat;		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(843)
								tmp47 = tmp48->color;
							}
							HX_STACK_LINE(843)
						...
						HX_STACK_LINE(845)
						int tmp46 = this->borderStyle;		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(845)
						bool tmp47 = (tmp46 == (int)3);		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(845)
						if ((tmp47)){
							HX_STACK_LINE(850)
							{
								HX_STACK_LINE(850)
								::openfl::_legacy::text::TextFormat tmp48 = this->_formatAdjusted;		HX_STACK_VAR(tmp48,"tmp48");
								HX_STACK_LINE(850)
								::openfl::_legacy::text::TextFormat FormatAdjusted = tmp48;		HX_STACK_VAR(FormatAdjusted,"FormatAdjusted");
								HX_STACK_LINE(850)
								Dynamic tmp49;		HX_STACK_VAR(tmp49,"tmp49");
								HX_STACK_LINE(850)
								tmp49 = this->borderColor;
								HX_STACK_LINE(850)
								FormatAdjusted->color = tmp49;
								HX_STACK_LINE(850)
								{
									HX_STACK_LINE(850)
									::openfl::_legacy::text::TextField tmp50 = this->_textField;		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(850)
									::openfl::_legacy::text::TextFormat tmp51 = FormatAdjusted;		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(850)
									...
									HX_STACK_LINE(850)
									tmp50->setTextFormat(tmp51,(int)0,tmp54);
								}
								HX_STACK_LINE(850)
								{
									HX_STACK_LINE(850)
									...
									while((true)){
										...
										HX_STACK_LINE(850)
										::flixel::text::FlxTextFormat tmp52 = _g1->__get(_g).StaticCast< ::flixel::text::FlxTextFormat >();		HX_STACK_VAR(tmp52,"tmp52");
										HX_STACK_LINE(850)
										::flixel::text::FlxTextFormat format = tmp52;		HX_STACK_VAR(format,"format");
										HX_STACK_LINE(850)
										++(_g);
										HX_STACK_LINE(850)
										...
										if ((tmp58)){
											...
											HX_STACK_LINE(850)
											::String tmp59 = format->format->font;		HX_STACK_VAR(tmp59,"tmp59");
											HX_STACK_LINE(850)
											FormatAdjusted->font = tmp59;
											HX_STACK_LINE(850)
											Dynamic tmp60 = format->format->bold;		HX_STACK_VAR(tmp60,"tmp60");
											HX_STACK_LINE(850)
											FormatAdjusted->bold = tmp60;
											HX_STACK_LINE(850)
											Dynamic tmp61 = format->format->italic;		HX_STACK_VAR(tmp61,"tmp61");
											HX_STACK_LINE(850)
											FormatAdjusted->italic = tmp61;
											HX_STACK_LINE(850)
											Dynamic tmp62 = format->format->size;		HX_STACK_VAR(tmp62,"tmp62");
											HX_STACK_LINE(850)
											FormatAdjusted->size = tmp62;
											HX_STACK_LINE(850)
											Dynamic tmp63;		HX_STACK_VAR(tmp63,"tmp63");
											HX_STACK_LINE(850)
											tmp63 = format->borderColor;
											HX_STACK_LINE(850)
											FormatAdjusted->color = tmp63;
										}
										HX_STACK_LINE(850)
										::openfl::_legacy::text::TextField tmp59 = this->_textField;		HX_STACK_VAR(tmp59,"tmp59");
										HX_STACK_LINE(850)
										::openfl::_legacy::text::TextFormat tmp60 = FormatAdjusted;		HX_STACK_VAR(tmp60,"tmp60");
										HX_STACK_LINE(850)
										int tmp61 = format->start;		HX_STACK_VAR(tmp61,"tmp61");
										HX_STACK_LINE(850)
										int tmp62 = format->end;		HX_STACK_VAR(tmp62,"tmp62");
										HX_STACK_LINE(850)
										...
										HX_STACK_LINE(850)
										int tmp65 = tmp64.length;		HX_STACK_VAR(tmp65,"tmp65");
										HX_STACK_LINE(850)
										Float tmp66 = ::Math_obj::min(tmp62,tmp65);		HX_STACK_VAR(tmp66,"tmp66");
										HX_STACK_LINE(850)
										int tmp67 = ::Std_obj::_int(tmp66);		HX_STACK_VAR(tmp67,"tmp67");
										HX_STACK_LINE(850)
										tmp59->setTextFormat(tmp60,tmp61,tmp67);
									}
								}
							}
							HX_STACK_LINE(852)
							...
							HX_STACK_LINE(853)
							{
								...
								while((true)){
									HX_STACK_LINE(853)
									bool tmp48 = (_g < iterations);		HX_STACK_VAR(tmp48,"tmp48");
									HX_STACK_LINE(853)
									bool tmp49 = !(tmp48);		HX_STACK_VAR(tmp49,"tmp49");
									HX_STACK_LINE(853)
									if ((tmp49)){
									...
									HX_STACK_LINE(853)
									int iter = tmp50;		HX_STACK_VAR(iter,"iter");
									HX_STACK_LINE(855)
									::openfl::_legacy::geom::Matrix tmp51 = this->_matrix;		HX_STACK_VAR(tmp51,"tmp51");
									HX_STACK_LINE(855)
									Float tmp52 = itd;		HX_STACK_VAR(tmp52,"tmp52");
									HX_STACK_LINE(855)
									Float tmp53 = -(tmp52);		HX_STACK_VAR(tmp53,"tmp53");
									HX_STACK_LINE(855)
									Float tmp54 = itd;		HX_STACK_VAR(tmp54,"tmp54");
									HX_STACK_LINE(855)
									Float tmp55 = -(tmp54);		HX_STACK_VAR(tmp55,"tmp55");
									HX_STACK_LINE(855)
									tmp51->translate(tmp53,tmp55);
									HX_STACK_LINE(856)
									::flixel::util::loaders::CachedGraphics tmp56 = this->cachedGraphics;		HX_STACK_VAR(tmp56,"tmp56");
									HX_STACK_LINE(856)
									::openfl::_legacy::text::TextField tmp57 = this->_textField;		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(856)
									::openfl::_legacy::geom::Matrix tmp58 = this->_matrix;		HX_STACK_VAR(tmp58,"tmp58");
									HX_STACK_LINE(856)
									tmp56->bitmap->draw(tmp57,tmp58,null(),null(),null(),null());
									HX_STACK_LINE(857)
									::openfl::_legacy::geom::Matrix tmp59 = this->_matrix;		HX_STACK_VAR(tmp59,"tmp59");
									HX_STACK_LINE(857)
									Float tmp60 = (itd * (int)2);		HX_STACK_VAR(tmp60,"tmp60");
									HX_STACK_LINE(857)
									tmp59->translate(tmp60,(int)0);
									HX_STACK_LINE(858)
									::flixel::util::loaders::CachedGraphics tmp61 = this->cachedGraphics;		HX_STACK_VAR(tmp61,"tmp61");
									HX_STACK_LINE(858)
									...
									HX_STACK_LINE(858)
									tmp61->bitmap->draw(tmp62,tmp63,null(),null(),null(),null());
									HX_STACK_LINE(859)
									::openfl::_legacy::geom::Matrix tmp64 = this->_matrix;		HX_STACK_VAR(tmp64,"tmp64");
									HX_STACK_LINE(859)
									Float tmp65 = (itd * (int)2);		HX_STACK_VAR(tmp65,"tmp65");
									HX_STACK_LINE(859)
									tmp64->translate((int)0,tmp65);
									HX_STACK_LINE(860)
									::flixel::util::loaders::CachedGraphics tmp66 = this->cachedGraphics;		HX_STACK_VAR(tmp66,"tmp66");
									HX_STACK_LINE(860)
									...
									HX_STACK_LINE(860)
									tmp66->bitmap->draw(tmp67,tmp68,null(),null(),null(),null());
									HX_STACK_LINE(861)
									::openfl::_legacy::geom::Matrix tmp69 = this->_matrix;		HX_STACK_VAR(tmp69,"tmp69");
									HX_STACK_LINE(861)
									Float tmp70 = itd;		HX_STACK_VAR(tmp70,"tmp70");
									HX_STACK_LINE(861)
									Float tmp71 = -(tmp70);		HX_STACK_VAR(tmp71,"tmp71");
									HX_STACK_LINE(861)
									Float tmp72 = (tmp71 * (int)2);		HX_STACK_VAR(tmp72,"tmp72");
									HX_STACK_LINE(861)
									tmp69->translate(tmp72,(int)0);
									HX_STACK_LINE(862)
									::flixel::util::loaders::CachedGraphics tmp73 = this->cachedGraphics;		HX_STACK_VAR(tmp73,"tmp73");
									HX_STACK_LINE(862)
									::openfl::_legacy::text::TextField tmp74 = this->_textField;		HX_STACK_VAR(tmp74,"tmp74");
									HX_STACK_LINE(862)
									::openfl::_legacy::geom::Matrix tmp75 = this->_matrix;		HX_STACK_VAR(tmp75,"tmp75");
									HX_STACK_LINE(862)
									tmp73->bitmap->draw(tmp74,tmp75,null(),null(),null(),null());
									HX_STACK_LINE(863)
									::openfl::_legacy::geom::Matrix tmp76 = this->_matrix;		HX_STACK_VAR(tmp76,"tmp76");
									HX_STACK_LINE(863)
									Float tmp77 = itd;		HX_STACK_VAR(tmp77,"tmp77");
									HX_STACK_LINE(863)
									Float tmp78 = itd;		HX_STACK_VAR(tmp78,"tmp78");
									HX_STACK_LINE(863)
									Float tmp79 = -(tmp78);		HX_STACK_VAR(tmp79,"tmp79");
									HX_STACK_LINE(863)
									tmp76->translate(tmp77,tmp79);
									HX_STACK_LINE(864)
									hx::AddEq(itd,delta);
								}
							}
							HX_STACK_LINE(867)
							{
								...
								{
									HX_STACK_LINE(867)
									::openfl::_legacy::text::TextFormat tmp50 = this->_defaultFormat;		HX_STACK_VAR(tmp50,"tmp50");
									HX_STACK_LINE(867)
									tmp49 = tmp50->color;
								}
								HX_STACK_LINE(867)
				...
				::openfl::_legacy::text::TextFormat tmp34 = this->_formatAdjusted;		HX_STACK_VAR(tmp34,"tmp34");
				HX_STACK_LINE(872)
				::openfl::_legacy::text::TextFormat FormatAdjusted = tmp34;		HX_STACK_VAR(FormatAdjusted,"FormatAdjusted");
				HX_STACK_LINE(872)
				Dynamic tmp35;		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(872)
				{
					HX_STACK_LINE(872)
					::openfl::_legacy::text::TextFormat tmp36 = this->_defaultFormat;		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(872)
					tmp35 = tmp36->color;
				}
				HX_STACK_LINE(872)
				FormatAdjusted->color = tmp35;
				HX_STACK_LINE(872)
				{
					HX_STACK_LINE(872)
					::openfl::_legacy::text::TextField tmp36 = this->_textField;		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(872)
					::openfl::_legacy::text::TextFormat tmp37 = FormatAdjusted;		HX_STACK_VAR(tmp37,"tmp37");
					HX_STACK_LINE(872)
					::openfl::_legacy::text::TextField tmp38 = this->_textField;		HX_STACK_VAR(tmp38,"tmp38");
					HX_STACK_LINE(872)
					::String tmp39 = tmp38->get_text();		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(872)
					int tmp40 = tmp39.length;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(872)
					tmp36->setTextFormat(tmp37,(int)0,tmp40);
				}
				HX_STACK_LINE(872)
				{
					HX_STACK_LINE(872)
					...
					while((true)){
						...
						HX_STACK_LINE(872)
						::flixel::text::FlxTextFormat tmp38 = _g1->__get(_g).StaticCast< ::flixel::text::FlxTextFormat >();		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(872)
						::flixel::text::FlxTextFormat format = tmp38;		HX_STACK_VAR(format,"format");
						HX_STACK_LINE(872)
						++(_g);
						HX_STACK_LINE(872)
						...
						HX_STACK_LINE(872)
						int tmp43 = format->start;		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(872)
						...
						if ((tmp44)){
							...
							HX_STACK_LINE(872)
							::String tmp45 = format->format->font;		HX_STACK_VAR(tmp45,"tmp45");
							HX_STACK_LINE(872)
							FormatAdjusted->font = tmp45;
							HX_STACK_LINE(872)
							Dynamic tmp46 = format->format->bold;		HX_STACK_VAR(tmp46,"tmp46");
							HX_STACK_LINE(872)
							FormatAdjusted->bold = tmp46;
							HX_STACK_LINE(872)
							Dynamic tmp47 = format->format->italic;		HX_STACK_VAR(tmp47,"tmp47");
							HX_STACK_LINE(872)
							FormatAdjusted->italic = tmp47;
							HX_STACK_LINE(872)
							Dynamic tmp48 = format->format->size;		HX_STACK_VAR(tmp48,"tmp48");
							HX_STACK_LINE(872)
							FormatAdjusted->size = tmp48;
							HX_STACK_LINE(872)
							Dynamic tmp49;		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(872)
							tmp49 = format->format->color;
							HX_STACK_LINE(872)
							FormatAdjusted->color = tmp49;
						}
						HX_STACK_LINE(872)
						::openfl::_legacy::text::TextField tmp45 = this->_textField;		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(872)
						::openfl::_legacy::text::TextFormat tmp46 = FormatAdjusted;		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(872)
						int tmp47 = format->start;		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(872)
						int tmp48 = format->end;		HX_STACK_VAR(tmp48,"tmp48");
						HX_STACK_LINE(872)
						::openfl::_legacy::text::TextField tmp49 = this->_textField;		HX_STACK_VAR(tmp49,"tmp49");
						HX_STACK_LINE(872)
						::String tmp50 = tmp49->get_text();		HX_STACK_VAR(tmp50,"tmp50");
						...
						int tmp51 = tmp50.length;		HX_STACK_VAR(tmp51,"tmp51");
						HX_STACK_LINE(872)
						Float tmp52 = ::Math_obj::min(tmp48,tmp51);		HX_STACK_VAR(tmp52,"tmp52");
						HX_STACK_LINE(872)
						int tmp53 = ::Std_obj::_int(tmp52);		HX_STACK_VAR(tmp53,"tmp53");
						HX_STACK_LINE(872)
						tmp45->setTextFormat(tmp46,tmp47,tmp53);
					}
				}
			}
			HX_STACK_LINE(876)
			::flixel::util::loaders::CachedGraphics tmp34 = this->cachedGraphics;		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(876)
			::openfl::_legacy::text::TextField tmp35 = this->_textField;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(876)
			::openfl::_legacy::geom::Matrix tmp36 = this->_matrix;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(876)
			tmp34->bitmap->draw(tmp35,tmp36,null(),null(),null(),null());
		}
		HX_STACK_LINE(879)
		this->dirty = false;
		HX_STACK_LINE(882)
...
::String FlxText_obj::convertTextAlignmentFromString( ::String StrAlign){
	...
	if ((tmp)){
		HX_STACK_LINE(922)
		return HX_HCSTRING("right","\xdc","\x0b","\x64","\xe9");
	}
	else{
		HX_STACK_LINE(924)
		...
		if ((tmp1)){
			HX_STACK_LINE(926)
			return HX_HCSTRING("center","\xd5","\x25","\xdb","\x05");
		}
		else{
			HX_STACK_LINE(928)
			...
			if ((tmp2)){
				HX_STACK_LINE(930)
				return HX_HCSTRING("justify","\x50","\xdf","\xb5","\x83");
			}
			else{
				HX_STACK_LINE(934)
				return HX_HCSTRING("left","\x07","\x08","\xb0","\x47");
			}
		}
	}
	HX_STACK_LINE(920)
