...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/battlecity.png", "assets/images/battlecity.png");
		type.set ("assets/images/battlecity.png", AssetType.IMAGE);
		path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		path.set ("assets/images/tile.csv", "assets/images/tile.csv");
		type.set ("assets/images/tile.csv", AssetType.TEXT);
		path.set ("assets/images/tile.tmx", "assets/images/tile.tmx");
		type.set ("assets/images/tile.tmx", AssetType.TEXT);
		path.set ("assets/images/tile2.tmx", "assets/images/tile2.tmx");
