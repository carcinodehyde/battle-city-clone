...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/battlecity.png", __ASSET__assets_images_battlecity_png);
		type.set ("assets/images/battlecity.png", AssetType.IMAGE);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/tile.csv", __ASSET__assets_images_tile_csv);
		type.set ("assets/images/tile.csv", AssetType.TEXT);
		className.set ("assets/images/tile.tmx", __ASSET__assets_images_tile_tmx);
		type.set ("assets/images/tile.tmx", AssetType.TEXT);
		className.set ("assets/images/tile2.tmx", __ASSET__assets_images_tile2_tmx);
		type.set ("assets/images/tile2.tmx", AssetType.TEXT);
		...
		id = "assets/images/battlecity.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/tile.csv";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/images/tile.tmx";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/images/tile2.tmx";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_battlecity_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_images_go_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_tile_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_tile_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_images_tile2_tmx extends flash.utils.ByteArray { }
...
@:image("assets/images/battlecity.png") #if display private #end class __ASSET__assets_images_battlecity_png extends lime.graphics.Image {}
@:file("assets/images/images-go-here.txt") #if display private #end class __ASSET__assets_images_images_go_here_txt extends lime.utils.Bytes {}
@:file("assets/images/tile.csv") #if display private #end class __ASSET__assets_images_tile_csv extends lime.utils.Bytes {}
@:file("assets/images/tile.tmx") #if display private #end class __ASSET__assets_images_tile_tmx extends lime.utils.Bytes {}
@:file("assets/images/tile2.tmx") #if display private #end class __ASSET__assets_images_tile2_tmx extends lime.utils.Bytes {}
